            ...
            <div class="bg-primary rounded overflow-hidden" style="background-image: linear-gradient(180deg, #0e1aab, #ca2626);">
              <div class="pd-25 d-flex align-items-center">
               <i class="ion ion-bag tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Total  <br>Registration <br> By <strong style="color:#fff;"><?php echo $agentname ?></strong><br> This Month</p>
