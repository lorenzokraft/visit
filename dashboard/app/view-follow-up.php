...
<html lang="en">
  ...
  <!-- ########## END: RIGHT PANEL ########## -->
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">FOLLOW UP</h6>
          <p class="mg-b-40 tx-gray-600">This are clients on the follow up list </p>
    ...
    <table class="table table-valign-middle mg-b-0">
                <tbody>
                  <?php 
                    $qry = "SELECT * from followup ORDER by ID DESC LIMIT 10";
                    $run = $con -> query($qry);
                    if($run -> num_rows > 0){
