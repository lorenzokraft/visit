            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="email" name="email" value="some@email" placeholder="Enter staff email address">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="password" placeholder="choose default password">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="rePass"placeholder="Re enter password">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" data-placeholder="Choose ROle">
                    <option label="Choose country"></option>
                    <option value="USA">Super Admin</option>
                    <option value="UK">Admin</option>
                    <option value="China">Counselor</option>
