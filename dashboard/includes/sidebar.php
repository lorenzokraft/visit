...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
        ...
        <a href="view-all-registered.php" class="br-menu-link">
            <div class="br-menu-item">
                <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
                <span class="menu-item-label">View all Registered Client </span>
            </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        
        <a href="view-follow-up.php" class="br-menu-link">
            <div class="br-menu-item">
                <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <a href="#" class="br-menu-link">
            <div class="br-menu-item">
                ...
                <span class="menu-item-label">Backend Users  </span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <ul class="br-menu-sub nav flex-column">
            <li class="nav-item"><a href="view-all-accounts.php" class="nav-link">View all Users</a></li>

            <li class="nav-item"><a href="create-account.php" class="nav-link">Create Users</a></li>
        </ul>
