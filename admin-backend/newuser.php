<?php 
  ...
  $get_name = mysqli_query($con, "SELECT * from users where email = '$email'");
  $get_run = mysqli_fetch_assoc($get_name);

  $username = $get_run['username'];
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-phone"><?php echo $username; ?></span>
						</a>
						<!-- / User Navigation: User Link -->
		...
		<div class="navbar navbar-inverse" id="nav">
			...
			<div class="navbar-inner">
				...
				<ul class="nav">
					...
					<li><a href="enquires.php"><i class="icon-picture"></i> View Enquires</a></li>
					<!-- / Main Navigation: Gallery -->
					  ...
					  <div class="tab-pane active" id="tab-traffic">
						  ...
						  <!-- 	<div class="progress progress-mini">
							...
							<form method="post"> 
								...
								<button type="submit" name="submit" value="insert">Create Account</button>
...
if(isset($_POST['submit'])) {
	...
	$qry = "INSERT INTO agent (Username, Password, Email, created_by) VALUES ('$name', '$password', '$email', '$username')";
